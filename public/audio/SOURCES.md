...
The edited game clips in this directory were made from files downloaded by the project
owner from Pixabay and are used under the Pixabay Content License.

| Game files | Pixabay source | Editing |
| --- | --- | --- |
| `arrow-flight.mp3` | [Arrow Swish 03 by DJArtMusic](https://pixabay.com/sound-effects/arrow-swish-03-306040/) | Trimmed to the audible 0.3-second flight and faded out. |
| `arrow-hit.mp3` | [Arrow Impact by freesound_community](https://pixabay.com/sound-effects/arrow-impact-87260/) | Silence trimmed and tail faded. |
| `build-tower.mp3` | [Hammering Nail](https://pixabay.com/sound-effects/hammering-nail-96677/) and [Deeper Saw Wood](https://pixabay.com/sound-effects/deeper-saw-wood-37224/) by freesound_community | Three widely spaced hammer blows over a prominent hand-saw pass; 2.2 seconds total. |
| `ui-click.mp3` | [Hammering Nail by freesound_community](https://pixabay.com/sound-effects/hammering-nail-96677/) | A single transient trimmed to 0.1 seconds and filtered into a quiet, dry interface click. |
| `sell-tower.mp3` | [Gold Coin Sound by izafi](https://pixabay.com/sound-effects/gold-coin-sound-437271/) | Tail shortened and faded. |
